...
# Simple implementation of get_allow_patterns for TinyGrad
def get_allow_patterns(weight_map, shard):
    """Return allow patterns for filtering weights based on shard"""
    # For simplicity, return None to allow all weights
    # In a full implementation, this would filter based on shard layers
    return None
